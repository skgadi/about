...
export interface GSK_PKG_FL_ST_DB_RECORD_SERVER extends GSK_PKG_FL_ST_DB_RECORD {
...
export interface GSK_PKG_FL_ST_CHUNK_INFO extends GSK_PKG_FL_ST_FILE_CHUNK_META {
