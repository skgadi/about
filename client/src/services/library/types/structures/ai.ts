import type { GSK_USER_CONTRIBUTION, GSK_VALIDATION_AUTHORITY } from './users.js';
...
export type GSK_AI_RES_VALIDATION_AUTHORITY_WITH_INFO = GSK_VALIDATION_AUTHORITY;
